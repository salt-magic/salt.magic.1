  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <FadeIn className="relative z-10 max-w-[600px] mx-auto text-center px-[clamp(32px,6vw,80px)] py-[clamp(80px,10vw,120px)]">
        ...
        <h2 className="font-display text-[clamp(32px,5vw,48px)] font-normal leading-[1.15] text-white tracking-tight mb-5">
          Start remineralizing your water <em className="italic">today</em>
        </h2>
        <p className="text-[16px] font-light text-white/70 mb-10 max-w-[420px] mx-auto leading-relaxed">
