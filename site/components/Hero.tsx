        ...
        <div className="max-w-[720px]">
          ...
          <FadeIn delay={0.45}>
            <div className="flex items-center justify-center gap-4">
              <a
                href="#products"
                className="inline-block text-[12px] font-semibold uppercase tracking-[0.12em] px-9 py-4 rounded-pill bg-white text-ink hover:bg-gold hover:text-ink transition-colors duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-gold"
              >
                Shop Now
              </a>
              <a
                href="#why"
                className="inline-block text-[12px] font-semibold uppercase tracking-[0.12em] px-9 py-4 rounded-pill border border-white/60 text-white hover:bg-white/10 transition-colors duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-gold"
              >
                Learn More
              </a>
            </div>
